...
*/
	...
	__asm__(
		"movq $4,%%rcx\n"
        "movq $0,%%rdx\n"
        "LY:vmovups (%0,%%rdx,4),%%ymm0\n"
        "vmovups (%1),%%ymm1\n"
        "vmulps %%ymm1,%%ymm0,%%ymm0\n"
        "vmovups %%ymm0,(%0,%%rdx,4)\n"
        "vmovups (%2,%%rdx,4),%%ymm0\n"
        "vmovups (%3),%%ymm2\n"
        "vmulps %%ymm2,%%ymm0,%%ymm0\n"
        "vmovups %%ymm0,(%2,%%rdx,4)\n"
        "vmovups (%4,%%rdx,4),%%ymm0\n"
        "vmovups (%5),%%ymm3\n"
        "vmulps %%ymm3,%%ymm0,%%ymm0\n"
        "vmovups %%ymm0,(%4,%%rdx,4)\n"
        "add $8,%%rdx\n"
        "loop LY\n"
        :
	...
	for( ; num < 86; alpha -=3 )
	{
		...
		for(int pixel=0;pixel<Height*Width; pixel += 32)
		{
            ...
            __asm__(
                ...
                "movq $4,%%rcx\n"
                "movq $0,%%rdx\n"
                "L:vmovups (%0,%%rdx,4),%%ymm0\n"
                "vmovups (%3,%%rdx,4),%%ymm1\n"
                "vmulps %%ymm2,%%ymm0,%%ymm0\n"
                "vmulps %%ymm3,%%ymm1,%%ymm1\n"
                "vaddps %%ymm1,%%ymm0,%%ymm0\n"
                "vdivps %%ymm4,%%ymm0,%%ymm0\n"
                "vmovups %%ymm0,(%0,%%rdx,4)\n"
                "vmovups (%1,%%rdx,4),%%ymm0\n"
                "vmovups (%4,%%rdx,4),%%ymm1\n"
                "vmulps %%ymm2,%%ymm0,%%ymm0\n"
                "vmulps %%ymm3,%%ymm1,%%ymm1\n"
                "vaddps %%ymm1,%%ymm0,%%ymm0\n"
                "vdivps %%ymm4,%%ymm0,%%ymm0\n"
                "vmovups %%ymm0,(%1,%%rdx,4)\n"
                "vmovups (%2,%%rdx,4),%%ymm0\n"
                "vmovups (%5,%%rdx,4),%%ymm1\n"
                "vmulps %%ymm2,%%ymm0,%%ymm0\n"
                "vmulps %%ymm3,%%ymm1,%%ymm1\n"
                "vaddps %%ymm1,%%ymm0,%%ymm0\n"
                "vdivps %%ymm4,%%ymm0,%%ymm0\n"
